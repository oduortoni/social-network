...
export function AuthPanel() {
  ...
  return (
    ...
    >
      ...
      >
        <form className="bg-white h-full px-[50px] flex flex-col justify-center items-center text-center">
          ...
          <input
            ...
            className="bg-gray-200 p-3 my-2 w-full outline-none"
          />
          <a href="#" className="text-sm text-gray-700 mt-2 mb-4">
            Forgot your password?
          </a>
          <button className="rounded-full border border-[#010c66] bg-[#010c66] text-white text-xs font-bold py-3 px-11 uppercase hover:scale-95 transition-transform">
            Sign In
          </button>
        </form>
      </div>
      ...
      >
        <div
          className={`absolute left-[-100%] w-[200%] h-full bg-gradient-to-r from-[#363a80] to-[#2a2a86] text-white flex transition-transform duration-700 ${
